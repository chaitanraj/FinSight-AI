  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16 max-w-3xl mx-auto">
        <h1 className="text-4xl mt-10 sm:text-5xl font-bold text-white mb-6">
      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-8 mb-8">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-1">Send your feedback</h4>
                  <p className="text-gray-400 text-sm mb-2">We value your opinion and would love to hear from you. Fill the form or mail us directly.</p>
        ...
        <div className="relative">
          <div className="bg-gray-900 mb-10 border border-gray-800 rounded-3xl p-8 shadow-2xl relative z-10">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-500/20 cursor-pointer hover:shadow-emerald-500/40 transition-all transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>Processing...</>
                  ) : (
